...
class BaseDataSets(Dataset):
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        if self.split == 'train':
            ...
            # BM
            # with open(self._base_dir + '/val_40.txt', 'r') as f:
            # prostate
    ...
    def __getitem__(self, idx):
        ...
        # BM
        # if self.split == "train":
        #     h5f = h5py.File(self._base_dir + "/h5_images/data/{}.h5".format(case), 'r')
        # else:
        #     h5f = h5py.File(self._base_dir + "/h5_images/{}.h5".format(case), 'r')
        image = h5f['image'][:]
        label = h5f['label'][:]
